...
val scenarioFixtureSourceSets = extensions.getByType<SourceSetContainer>()
val scenarioFixtureRuntime = scenarioFixtureSourceSets.named("main").get().runtimeClasspath
...
val scenarioBranchFixtures = listOf(
    ...
    scenarioBranchFixture("verifyR00ClassicRecalculate", "--scenario=R_00", "--verify-choice-script=0,0,2,3"),
    scenarioBranchFixture("verifyR00ClassicTrainingMode", "--scenario=R_00", "--verify-choice-script=0,0,0", "--verify-stop-at-choice"),
    scenarioBranchFixture("verifyR00ClassicDifficulty", "--scenario=R_00", "--verify-choice-script=0,0,1,3"),
    scenarioBranchFixture("verifyR00ExpandedMode", "--scenario=R_00", "--verify-choice-script=0,1,0", "--verify-stop-at-choice"),
    scenarioBranchFixture("verifyR00SelectMode", "--scenario=R_00", "--verify-choice-script=0,2,0", "--verify-stop-at-choice"),
    scenarioBranchFixture("verifyR00ModeDescription", "--scenario=R_00", "--verify-choice-script=0,3,0", "--verify-stop-at-choice"),
    ...
    scenarioBranchFixture("verifyS35Position2316ChoiceOne", "--scenario=S_35", "--verify-choice-script=0", "--verify-camp-positions=2:23:16"),
    scenarioBranchFixture("verifyS35Position2316ChoiceTwo", "--scenario=S_35", "--verify-choice-script=1", "--verify-camp-positions=2:23:16"),
    scenarioBranchFixture("verifyS35Position1901ChoiceOne", "--scenario=S_35", "--verify-choice-script=0", "--verify-camp-positions=2:19:1"),
    scenarioBranchFixture("verifyS35Position1901ChoiceTwo", "--scenario=S_35", "--verify-choice-script=1", "--verify-camp-positions=2:19:1"),
    ...
    scenarioBranchFixture("verifyS46DingjunRetreat", "--scenario=S_46", "--verify-choice-script=0", "--verify-camp-positions=2:23:16"),
    scenarioBranchFixture("verifyS46DingjunFight", "--scenario=S_46", "--verify-choice-script=1", "--verify-camp-positions=2:23:16"),
    scenarioBranchFixture("verifyS46HanzhongRetreat", "--scenario=S_46", "--verify-choice-script=0", "--verify-camp-positions=2:19:1"),
    scenarioBranchFixture("verifyS46HanzhongFight", "--scenario=S_46", "--verify-choice-script=1", "--verify-camp-positions=2:19:1"),
    ...
    scenarioBranchFixture("verifyS37CampFourBreakout", "--scenario=S_37", "--verify-choice-script=0", "--verify-vars=3:1", "--verify-camp-positions=0:0:17"),
    scenarioBranchFixture("verifyS37CampFourResist", "--scenario=S_37", "--verify-choice-script=1", "--verify-vars=3:1", "--verify-camp-positions=0:0:17"),
...
tasks.named("check") {
    dependsOn("verifyScenarioChoiceCoverage", "verifyScenarioRandomCoverage")
}
