    ...
    @JvmStatic fun main(args: Array<String>) {
        ...
        Lwjgl3Application(JojoGame(GameLaunchConfiguration(
            ...
            scenarioRun = ScenarioRunConfiguration(
                choices = ints("--verify-choice-script="), allowPendingChoiceAfterScript = options.contains("--verify-stop-at-choice"),
                ...
                choiceTracePath = value("--choice-trace="), randomTracePath = value("--random-trace="),
