...
/** CmdRenderEvents: 검증 렌더 이벤트를 표현하는 타입이다. */
object CmdRenderEvents {
    /** DEFAULT: 검증 실행 문맥에서 사용하는 상태 값을 담는다. */
    ...
    /** SELECTED: 해당 검증 조건의 현재 여부를 나타낸다. */
    ...
    /** INFO: 검증 실행 문맥에서 사용하는 상태 값을 담는다. */
    ...
    /** jsonl: 해당 검증 단계의 입력을 처리해 상태를 갱신한다. */
