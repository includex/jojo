...
/** DefineUnitRenderEvents: 편집 화면 프리팹 이벤트를 압축 리소스에서 복원한다. */
object DefineUnitRenderEvents {
    ...
    /** RESET: reset 값을 보관해 검증 흐름에서 사용한다. */
    ...
    /** FINISH: finish 값을 보관해 검증 흐름에서 사용한다. */
    ...
    /** jsonl: 지정한 편집 경로의 그리기 이벤트를 JSONL로 반환한다. */
...
/** DefineUnitRouteScreen: 편집 흐름을 화면으로 실행하는 검증용 LibGDX 화면이다. */
