...
class ScenarioStoryEvidenceRecorderTest {
    ...
    @Test fun `panel fixture retains its byte exact JSONL contract`() {
        assertEquals(
            "{\"sequence\":0,\"frame\":0,\"timestamp\":0,\"phase\":\"hall-panel-stable\",\"layer\":\"HallLayer\",\"nodePath\":\"Canvas/Layer/Panel_cancel\",\"drawType\":\"sprite\",\"x\":0.000,\"y\":0.000,\"w\":1280.000,\"h\":688.000,\"assetId\":\"assets/internal/native/02/0275e94c-56a7-410f-bd1a-fc7483f7d14a.cea68.png#default_sprite_splash\",\"opacity\":0.000,\"blend\":[770, 771],\"visible\":false,\"text\":null,\"color\":null,\"outline\":null}\n" +
                "{\"sequence\":1,\"frame\":0,\"timestamp\":0,\"phase\":\"hall-panel-stable\",\"layer\":\"DialogueLayer\",\"nodePath\":\"Canvas/Layer/bg0/bg2\",\"drawType\":\"sprite\",\"x\":274.540,\"y\":55.470,\"w\":686.280,\"h\":164.260,\"assetId\":\"U_select_10-1\",\"opacity\":1.000,\"blend\":[770, 771],\"visible\":true,\"text\":null,\"color\":null,\"outline\":null}\n",
