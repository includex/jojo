        ...
        val result = TacticalActionResult.Attack(
            ...
            physicalPasses = listOf(
                PhysicalAttackPass(
                    ...
                    critical = false,
                    targets = listOf(
                        PhysicalAttackTargetResult("primary", sourceHarm = 20, damage = 20),
                        PhysicalAttackTargetResult(
                            "splash", sourceHarm = 10, damage = 10,
                            recoilDamage = 2,
                ...
                PhysicalAttackPass(
                    ...
                    "attacker",
                    critical = true,
                    targets = listOf(PhysicalAttackTargetResult("primary", sourceHarm = 8, damage = 8)),
                ),
            ),
        )
