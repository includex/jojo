...
/**
 * Compatibility codec for the original Cocos UserDefault save envelope.
 *
 * The original game prefixes an MD5 digest and rotates every byte by a
 * position-dependent amount. Keeping this format lets the Kotlin port read
 * and write the same durable save container rather than inventing a second
 * incompatible persistence format.
 */
object OriginalSaveCodec {
