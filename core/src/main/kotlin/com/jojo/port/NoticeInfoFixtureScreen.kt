...
/**
 * Actual port route: BattleLayer id 1 owns the persistent NoticeInfoLayer id
...
object NoticeInfoBattleRenderEvents {
    ...
    fun jsonl(state: String, route: BattleNoticeRoute): String {
        ...
        units.forEachIndexed { index, unit ->
            ...
            draw("Canvas/Layer/ScrollView/view/content/map/unit/mask/node", "sprite", unit.x, unit.y, 96f, 96f,
                "assets/Game/native/${unit.atlas}.png#$frame")
            draw("Canvas/Layer/ScrollView/view/content/map/unit/info/bar2/sprite", "sliced-sprite",
