...
class AchievementsFixtureScreen(private val game: JojoGame) : ScreenAdapter() {
    ...
    fun renderEventLog(): String {
        ...
        fun draw(layer: String, path: String, type: String, x: Float, y: Float, w: Float, h: Float,
            ...
            log.draw(phase, layer, path, type, x, y, w, h, asset, opacity,
        ...
        draw("HallLayer", "Canvas/Layer/Panel_cancel", "sprite", 0f, 0f, 1488.372f, 800f,
        ...
        if (!removed) {
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0", "sprite", 161.686f, 643f, 1161f, 70f, "bg1")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/box3", "sliced-sprite", 161.686f, 643f, 1161f, 70f, "box3")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label0", "label", 180.186f, 652.091f, 540f, 54f, text = "R 첫 전투")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label1", "label", 848.962f, 651.891f, 230.82f, 54.4f, text = "Lv:2 Gold:30")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label2", "label", 1080.806f, 641.534f, 226.38f, 79.6f, text = "★  ☆  ★")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0", "sprite", 161.686f, 569f, 1161f, 70f, "bg1")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/box3", "sliced-sprite", 161.686f, 569f, 1161f, 70f, "box3")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label0", "label", 180.186f, 578.091f, 540f, 54f, text = "S 영천 전투")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label1", "label", 871.212f, 577.891f, 208.57f, 54.4f, text = "Lv:9 Gold:0")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/scrollview/view/content/item0/label2", "label", 1080.806f, 567.534f, 226.38f, 79.6f, text = "☆  ★  ☆")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/button0/Background", "sliced-sprite", 1172.451f, 32.187f, 147.6f, 56f, "box3")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/button0/Background/Label", "label", 1196.251f, 41.187f, 100f, 40f, text = "확인")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/button1/Background", "sliced-sprite", 1007.406f, 32.187f, 147.6f, 56f, "box3")
            draw("HallLayer", "Canvas/Layer/Logo_12-1/button1/Background/Label", "label", 1031.206f, 41.187f, 100f, 40f, text = "도움말")
        }
        return log.jsonl()
    }

    override fun resize(width: Int, height: Int) = viewport.update(width, height, true)
    override fun dispose() { batch.dispose(); background.dispose(); panel.dispose(); font.dispose() }
}
