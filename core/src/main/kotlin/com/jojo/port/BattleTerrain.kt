...
/** Original Hexzmap terrain grid used by BattleLayer.getBattleTerrain(x, y). */
data class BattleTerrainGrid(
    val width: Int,
    val height: Int,
    val rows: List<IntArray>,
) {
    /** Runtime terrain replacements made through BattleLayer.setObject2. */
    ...
    /** BattleLayer.setFire/setFires calls setObject2 with TERRAIN.HUO (26). */
