...
/** Port half of tools/battle_layer_source_trace_harness.js. */
object BattleLayerTraceHarness {
    ...
    @JvmStatic fun main(args:Array<String>) {
        ...
        val output=cases.joinToString(prefix="[",postfix="]") { m ->
            val units=Regex("\\{\\\"control\\\":(true|false),\\\"exist\\\":(true|false),\\\"acted\\\":(true|false)}")
                .findAll(m.groupValues[5]).map { u -> BattleLayerIsolatedUnit(u.groupValues[1]=="true",u.groupValues[2]=="true",u.groupValues[3]=="true") }.toList()
            val layer=BattleLayerIsolatedContract(units,m.groupValues[4]=="true",m.groupValues[3].toInt())
