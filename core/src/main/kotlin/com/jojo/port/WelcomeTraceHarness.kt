...
/** Direct lifecycle port of recovered ui/Welcome.js. */
private class WelcomePort {
...
object WelcomeTraceHarness {
    ...
    @JvmStatic fun main(args: Array<String>) {
        ...
        val json=cases.joinToString(",","{","}") { m ->
            val p=WelcomePort(); p.onCreate(); val trace=mutableListOf("{\"step\":\"create\",\"routes\":${routes(p.routes)}}")
