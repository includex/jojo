...
/** Isolated port-side equivalent of the Electron BattleUnit.setAction2 fixture. */
class BattleSpriteFixtureScreen(
    ...
    private val profile = requireNotNull(originalData.unitProfile(characterId)) { "Unknown fixture character: $characterId" }
    private val arm = requireNotNull(originalData.armProfile(profile.armId))
    private val avatar = requireNotNull(BattleAvatarResolver.resolve(originalData, characterId, profile.posts, arm.id, faction))
