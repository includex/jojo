...
/** Decisions shared by the normal BattleLayer route and its end-to-end transition test. */
object NaturalBattleTransition {
    ...
    /**
     * A result may be observed while BattleLayer is still waiting for a
     ...
     * or once BattleLayer's source-equivalent end-process scene is active.
     */
