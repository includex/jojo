...
class DialogueFixtureScreen(private val game: JojoGame, private val state: String) : ScreenAdapter() {
    ...
    fun renderEventLog(): String {
        ...
        if (dialogue.view().bubble == 0) {
            ...
            draw("DialogueLayer", "Canvas/Layer/bg0/bg2/richtext", "rich-text", 382.487f, 111.814f, 728f, 94.92f,
                text = "왼쪽 첫 문장<br/>둘째 줄")
            draw("DialogueLayer", "Canvas/Layer/bg0/bg2/richtext/RICHTEXT_CHILD", "label", 382.487f, 153.814f, 175.7f, 52.92f,
                text = "왼쪽 첫 문장")
            draw("DialogueLayer", "Canvas/Layer/bg0/bg2/richtext/RICHTEXT_CHILD", "label", 382.487f, 111.814f, 103.42f, 52.92f,
                text = "둘째 줄")
            ...
            draw("DialogueLayer", "Canvas/Layer/bg1/bg2/richtext", "rich-text", 396.655f, 153.814f, 728f, 52.92f,
                text = "오른쪽 대사")
            draw("DialogueLayer", "Canvas/Layer/bg1/bg2/richtext/RICHTEXT_CHILD", "label", 396.655f, 153.814f, 165.7f, 52.92f,
                text = "오른쪽 대사")
