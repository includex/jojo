...
internal object HallExclusiveRenderer {
    ...
    fun draw(assets: ScenarioSceneAssets, batch: SpriteBatch, view: HallExclusiveView) {
        ...
        label(SystemMessage.S_FF78287D6C, 669.431f, 702.8f, 149.51f)
        if (view.selectedTab == HallExclusiveView.Tab.SET_LIST) {
            ...
            header(138.586f, 642.1f, 236f, SystemMessage.S_8C4DAC1FCC)
            header(374.586f, 642.1f, 233f, SystemMessage.S_BD54114CB4)
            header(607.636f, 642.1f, 236.5f, SystemMessage.S_51378A4614)
            header(844.036f, 642.1f, 506.1f, SystemMessage.S_9940B21F7F)
        } else {
            ...
            header(140.85f, 643.3f, 185f, SystemMessage.S_E6B2B4DBC0)
            header(324.236f, 643.3f, 243.9f, SystemMessage.S_9AA18E5071)
            header(568.186f, 643.3f, 780f, SystemMessage.S_9940B21F7F)
        }
        button(354.241f, SystemMessage.S_7072EC6F49, 167f)
        button(147.282f, SystemMessage.S_8DD48EC033, 167f)
        button(1141.864f, SystemMessage.S_468266D639, 100f)
        batch.color = Color.WHITE
    }
}
