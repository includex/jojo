...
internal data class ScenarioBattlefieldUnitView(
    ...
    val visualX: Float,
    val visualY: Float,
    val sourceWorldCenterX: Double,
    val sourceWorldCenterY: Double,
    val sourceWorldLeft: Float,
    val sourceWorldBottom: Float,
    val sourceWorldRight: Float,
    val sourceWorldTop: Float,
    val visible: Boolean,
    val zIndex: Float,
