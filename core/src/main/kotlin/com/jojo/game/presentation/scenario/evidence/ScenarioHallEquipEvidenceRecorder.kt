...
internal data class ScenarioHallEquipEvidenceSlot(
    val name: String,
    val level: Int,
    val experience: Int,
    val icon: Int?,
...
/** Complete immutable projection for the Hall equipment evidence layer. */
internal data class ScenarioHallEquipEvidenceInput(
    val fixture: String?,
    val unitName: String,
    ...
    val level: Int,
    val stats: List<Int>,
    val slots: List<ScenarioHallEquipEvidenceSlot>,
)
...
internal class ScenarioHallEquipEvidenceRecorder(
    ...
    fun append(log: RenderEventLog, phase: String = "hall-equip-stable", layer: String = "EquipLayer") {
        ...
        if (input.fixture == "unit-list-close") event("$base/face/bg0", "sliced-sprite", 894.812f, 413.337f, 192f, 240f, "box2")
