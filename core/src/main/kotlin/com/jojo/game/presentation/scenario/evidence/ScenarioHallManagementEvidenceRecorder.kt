...
internal enum class ScenarioHallManagementEvidenceKind { BUY, SELL }

internal data class ScenarioHallManagementBuyRow(
    val name: String,
    val typeName: String,
...
internal data class ScenarioHallManagementEquipment(val name: String, val level: Int)

internal data class ScenarioHallManagementUnitEvidence(
    val name: String,
...
internal data class ScenarioHallManagementEvidenceInput(
    val kind: ScenarioHallManagementEvidenceKind,
    val money: Int,
    val buyRows: List<ScenarioHallManagementBuyRow>,
    val unit: ScenarioHallManagementUnitEvidence,
)
