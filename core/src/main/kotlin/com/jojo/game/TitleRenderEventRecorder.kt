...
internal class TitleRenderEventRecorder {
    fun record(state: TitleViewState, startItemFixture: Boolean = false): String {
        ...
        floatArrayOf(582f, 456f, 329f, 203f).forEachIndexed { index, y ->
            log.draw("login-main-stable", "Login", "Canvas/Layer/bg1/button$index/Background", "sliced-sprite",
    ...
    private fun appendLoad(log: RenderEventLog, state: TitleViewState) {
        fun event(path: String, type: String, x: Float, y: Float, w: Float, h: Float,
            ...
            log.draw("login-load-stable", layer, path, type, x * SCALE, y * SCALE, w * SCALE, h * SCALE,
        ...
        state.loadConfirmationMessage?.let { message ->
            event("Canvas/Layer/Panel_cancel", "sprite", 0f, 0f, 1488.372f, 800f, "default_sprite_splash",
    ...
    private fun appendSettings(log: RenderEventLog, state: TitleViewState) {
        ...
        fun event(path: String, type: String, x: Float, y: Float, w: Float, h: Float,
            ...
            log.draw("login-setting-stable", "SettingLayer", path, type, x * SCALE, y * SCALE, w * SCALE, h * SCALE,
        ...
        rects.forEachIndexed { index, (x, y) ->
            ...
            if (view.flags and (1 shl index) != 0) event("$path/checkmark", "sprite", if (index == 2) 218.186f else x, y, 28f, 28f, "default_toggle_checkmark")
        ...
        event("Canvas/Layer/bg/scrollview/view/content/panel1/slider/Handle", "sliced-sprite", 800.186f + 434f * view.gameSpeed, 412.346f, 32f, 32f, "default_radio_button_off")
        ...
        floatArrayOf(831.12f, 933.12f, 1035.12f, 1137.12f).forEachIndexed { index, x ->
            ...
            if (view.background == index) event("$path/box6", "tiled-sprite", x, 92.703f, 100f, 100f, "box6",
