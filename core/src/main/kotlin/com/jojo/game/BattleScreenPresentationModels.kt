...
data class BattleScreenIsolatedView(val paused: Boolean, val modal: Boolean, val action: Boolean, val events: List<String>)
class BattleScreenIsolatedContract(private val units: List<BattleScreenIsolatedUnit>, private val collocation: Boolean, private val round: Int) {
