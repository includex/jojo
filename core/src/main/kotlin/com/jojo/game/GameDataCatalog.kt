...
class GameDataCatalog private constructor(
    ...
    private val units = tables.units
    private val arms = tables.arms
    private val posts = tables.posts
    private val hitareas = tables.hitAreas
    private val effareas = tables.effectAreas
    private val magics = tables.magics
    private val items = tables.items
    private val itemSkills = tables.itemSkills
    private val unitPostSkills = tables.unitPostSkills
    private val defineSkills = tables.defineSkills
    private val shops = tables.shops
    private val config = tables.config
    private val gameConfig = tables.gameConfig
    ...
    /** Original GAME_CFG.terrain[n].resumeMP, applied by BattleScreen._stateProcess. */
    ...
    /**
     * The complete original item table subset accepted by BattleScreen._usePro2.
