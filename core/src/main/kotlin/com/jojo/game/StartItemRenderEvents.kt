...
object StartItemRenderEvents {
    fun jsonl(): String {
        ...
        log.draw(phase, "HallLayer", "Canvas/bg", "sprite", 0f, 0f, 1488.372f, 800f,
            "assets/resources/native/4d/4debf9ca-54d9-48e2-855c-34ef06c80bc4.5e28d.jpg#Logo_1-1")
        log.draw(phase, "HallLayer", "Canvas/Layer/Panel_cancel", "sprite", 0f, 0f, 1488.372f, 800f,
        ...
        ys.forEachIndexed { index, y ->
            log.draw(phase, "Login", "Canvas/Layer/bg1/button$index/Background", "sliced-sprite",
