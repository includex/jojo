...
internal class BattlePreparationTraceRecorder {
    ...
    private fun battleSortEvents(route: String): String {
        ...
        }.jsonl().let { if (open) it.replace("\"layer\":\"StartBattleScreen\"", "\"layer\":\"BattleSortLayer\"") else it }
        if (!open) return base
        ...
        labels.forEachIndexed { index, value ->
            ...
            extra.draw(phase, "HallLayer", "Canvas/Layer/menu/button1_$index/Background/Label", "label",
    ...
    private fun battleViewEvents(): String {
        ...
        draw("BattleViewLayer", "Canvas/Layer/bg", "sprite", 1008.372f, 320f, 480f, 480f, "default_sprite_splash", .667f)
        draw("BattleViewLayer", "Canvas/Layer/bg/map/view/content/map1", "sprite", 1008.372f, 320f, 480f, 480f,
            "assets/Game/native/4a/4afa0804-1ac2-4d59-97e4-1549a9425953.6295a.jpg#HM_1-1")
        repeat(4) { index ->
            val x = 1104.372f + index * 24f
            draw("BattleViewLayer", "Canvas/Layer/bg/map/view/content/map1/box6", "sliced-sprite", x, 680f, 24f, 24f,
                "Mark_47-1", if (index == 1) 1f else .502f)
            draw("BattleViewLayer", "Canvas/Layer/bg/map/view/content/map1/box6/box3", "sprite", x, 680f, 24f, 24f, "box3")
            draw("BattleViewLayer", "Canvas/Layer/bg/map/view/content/map1/box6/label", "label", x + 6.272f, 681.13f,
