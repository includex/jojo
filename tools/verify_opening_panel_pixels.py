#!/usr/bin/env python3
"""Strict bottom-left RGBA8 equality for the isolated first R00 dialogue panel."""
import argparse
import hashlib
import json
...
def compare(source, game, width=2560, height=1376):
    ...
    return {"contract": "isolated-opening-panel-rgba8", "width": width, "height": height,
...
def main():
    ...
    report = compare(args.source.read_bytes(), args.game.read_bytes())
    if args.report:
