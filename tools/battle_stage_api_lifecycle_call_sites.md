...
### `stage.loadBg`
- S: `BattleScreen.loadBg` (battle/BattleLayer.js:2948); signals=pause, resume, callback; contract hash matches
...
### `stage.setUnitAttr`
- S: `BattleScreen.setUnitAttr` (battle/BattleLayer.js:11167); signals=assetLoad; contract hash matches
...
### `stage.resumeCtrl`
- S: `BattleScreen.resumeCtrl` (battle/BattleLayer.js:5121); signals=callback; no contract hash for this route
