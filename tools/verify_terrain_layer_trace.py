...
a=json.loads(subprocess.check_output(['node',str(r/'tools/terrain_layer_source_trace_harness.js'),str(f)],text=True));b=json.loads(subprocess.check_output([str(r/'gradlew'),'-q',':verification:terrainLayerTrace'],cwd=r,text=True))
